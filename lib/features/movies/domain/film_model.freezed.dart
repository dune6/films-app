...
class _$_Film implements _Film {
  ...
  @override
  String toString() {
    return 'Film(id: $id, name: $name, alternativeName: $alternativeName, enName: $enName, names: $names, type: $type, year: $year, description: $description, shortDescription: $shortDescription, logo: $logo, poster: $poster, backdrop: $backdrop, rating: $rating, votes: $votes, movieLength: $movieLength, genres: $genres, countries: $countries)';
  }
